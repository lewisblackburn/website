---
name: Petal
description: Petal is a comprehensive database that brings together information about films, TV shows, books, people, and songs, all in one convenient platform.
homepage: https://petal.fly.dev
github: https://github.com/lewisblackburn/petal
techstack:
  - label: Remix
  - label: SQLite
  - label: Tailwind
