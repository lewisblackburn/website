...
modifiedTime: '2024-02-19T00:00:00Z'
...
There was always something that couldn't be bypassed. Here's how I *eventually* solved it.
...
If you have any suggestions please let me know! ([reference](https://github.com/search?q=repo%3Azxffo/petal%20getOldValue&type=code)).
...
they are equal there is no need to create an audit log [(reference)](https://github.com/zxffo/petal/blob/6d2b1941fa2991a9516ee663f2e4259ab9e12120/app/utils/misc.tsx#L666
).
